...
<header class="box-header" >
  <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" style="height: 70px;">
    <div class="container">
      <a class="navbar-brand" id="logo" href="../../index.php">Shaddai</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="../../index.php"><i class='bx bxs-home-heart'></i> Inicio</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class='bx bxs-user-plus'></i> Unete</a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item btn-primary" href="../../php/procesos/login2.php"><i class='bx bxs-user-check' ></i> Iniciar Seccion</a></li>
            <li><a class="dropdown-item" href="../../php/procesos/regis.php"><i class='bx bx-id-card'></i> Registrarme</a></li>
          </ul>
          </li>
        </ul>
        ...
        <div>
            <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-top: 80px;">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="men-tab" data-bs-toggle="tab" data-bs-target="#men-tab-pane" type="button" role="tab" aria-controls="men-tab-pane" aria-selected="true">Caballero</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="girl-tab" data-bs-toggle="tab" data-bs-target="#girl-tab-pane" type="button" role="tab" aria-controls="girl-tab-pane" aria-selected="false">Damas</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="kids-tab" data-bs-toggle="tab" data-bs-target="#kids-tab-pane" type="button" role="tab" aria-controls="kids-tab-pane" aria-selected="false">Niños</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="saco-tab" data-bs-toggle="tab" data-bs-target="#saco-tab-pane" type="button" role="tab" aria-controls="saco-tab-pane" aria-selected="false">Bolsillo</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="all-tab" data-bs-toggle="tab" data-bs-target="#all-tab-pane" type="button" role="tab" aria-controls="all-tab-pane" aria-selected="false">Todo</button>
              </li>
            </ul>
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="men-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0"><section class="home" id="men" style="margin-top: 10px; background-color: azure;">
            <div class="ctlg">
              <div class="titulo">
              ...
              <div class="container">
                ...
                <?php endforeach; ?>
                        ...
                        <div class="tab-pane fade" id="girl-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0"><section class="home" id="girl" style="margin-top: 10px;" >
            <div class="ctlg">
              <div class="titulo">
                <h1 style="text-align: center;">Conocimientos de Dios</h1>
              </div>
              <div class="container">
                ...
                <?php endforeach; ?>
                        ...
                        <div class="tab-pane fade" id="kids-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0"><section class="home" id="kids" style="margin-top: 10px; ">
            <div class="ctlg">
              <div class="titulo">
                <h1 style="text-align: center;">Conocimientos de Dios</h1>
              </div>
              <div class="container">
                ...
                <?php endforeach; ?>
                        ...
                        <div class="tab-pane fade" id="saco-tab-pane" role="tabpanel" aria-labelledby="disabled-tab" tabindex="0"><section class="home" id="saco" style="margin-top: 10px;">
            <div class="ctlg">
              <div class="titulo">
                <h1 style="text-align: center;">Conocimientos de Dios</h1>
              </div>
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="all-tab-pane" role="tabpanel" aria-labelledby="all-tab" tabindex="0"><section class="home" id="all" style="margin-top: 10px;">
            <div class="ctlg">
              <div class="titulo">
                <h1 style="text-align: center;">Conocimientos de Dios</h1>
              </div>
