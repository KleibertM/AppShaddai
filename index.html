...
$sql = "SELECT * FROM item WHERE cat = 'DAMAS'  LIMIT 3";
$result = $conexion->query($sql);
...
<head>
    ...
    <title>Shaddai - Libreria Cristiana</title>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
            <div class="container">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="pages/categoria/all.php"><i class='bx bxs-book-alt'></i> Catalogo</a>
                    </li>
                    <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class='bx bxs-user-plus'></i> Unete
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item btn-primary" href="php/procesos/login2.php"><i class='bx bxs-user-check' ></i> Iniciar Seccion</a></li>
                        <li><a class="dropdown-item btn-success" href="php/procesos/regis.php"><i class='bx bx-id-card'></i> Registrarme</a></li>
                    </ul>
                    </li>
                </ul>
        ...
        <div id="carouselExample" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/images/firt_cat/fondos/1.png" alt="Biblia 1" class="w-100">
